// Ibl_Specular_Textured.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
#include "Communal/Communal/Camera.h"
#include "Communal/Communal/Shader.h"
#include "Communal/Communal/Model.h"
...
int main()
{
    ...
    // -------------------------
    Shader pbrShader("../../../resources/shaders/ibl_specular_textured_pbr.vs", "../../../resources/shaders/ibl_specular_textured_pbr.fs");
    Shader equirectangularToCubemapShader("../../../resources/shaders/ibl_specular_textured_cubemap.vs", "../../../resources/shaders/ibl_specular_textured_equirectangular_to_cubemap.fs");
    Shader irradianceShader("../../../resources/shaders/ibl_specular_textured_cubemap.vs", "../../../resources/shaders/ibl_specular_textured_irradiance_convolution.fs");
    Shader prefilterShader("../../../resources/shaders/ibl_specular_textured_cubemap.vs", "../../../resources/shaders/ibl_specular_textured_prefilter.fs");
    Shader brdfShader("../../../resources/shaders/ibl_specular_textured_brdf.vs", "../../../resources/shaders/ibl_specular_textured_brdf.fs");
    Shader backgroundShader("../../../resources/shaders/ibl_specular_textured_background.vs", "../../../resources/shaders/ibl_specular_textured_background.fs");
