...
int main()
{
    ...
    // --------------------
    std::string windowTitle = "尘海折柳:【菜鸟驿站:LearnOpenGL2进阶—PBR_Lighting_textured】";
    ...
    // -------------------------
    Shader shader("../../../resources/shaders/pbr_lighting_textured_pbr.vs", "../../../resources/shaders/pbr_lighting_textured_pbr.fs");
